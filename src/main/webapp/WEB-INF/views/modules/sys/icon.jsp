...
<link rel="stylesheet" href="${ctx}/static/plug-ins/fonts/fontawesome/font-awesome.min.css" media="all"/>
<!--[if !IE]> -->
...
<script type="text/javascript"
	src="${ctx}/static/plug-ins/nicescroll/jquery.nicescroll.min.js"></script>
<link rel="stylesheet" href="${ctx }/static/css/webside-icon.min.css" />
<script type="text/javascript">
$(function() {
	$("li").each(function() {
